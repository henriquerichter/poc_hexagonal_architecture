...
import com.test.game.CreateGameUseCase.Out;
...
public class GameControllerTest {
  ...
  void givenNewGameDTO_whenCreate_thenReturnCreatedGame() {
    ...
    // when
    ResponseEntity<CreateGameUseCase.Out> actualResponse = (ResponseEntity<Out>) this.gameController.create(newGameDTO);
